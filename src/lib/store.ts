...
export const AdsStore = {
  ...
  getDefaults(): AdConfigData[] {
    return [
      ...
      { key: 'banner_top', label: 'Banner Topo — Anuncio horizontal no topo da pagina, acima do conteudo principal', value: '', enabled: false },
      { key: 'banner_middle', label: 'Banner Meio — Anuncio horizontal no meio da pagina, entre secoes de conteudo', value: '', enabled: false },
      { key: 'banner_bottom', label: 'Banner Rodape — Anuncio horizontal na parte inferior, acima do rodape do site', value: '', enabled: false },
      { key: 'in_content', label: 'In-Content — Anuncio fluido dentro do conteudo de artigos', value: '', enabled: false },
      ...
      { key: 'in_feed', label: 'In-Feed — Anuncio fluido na lista de artigos, entre os cards', value: '', enabled: false },
